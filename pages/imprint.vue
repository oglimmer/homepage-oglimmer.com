  ...
  <div class="max-w-4xl mx-auto">
    <div class="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-8 md:p-12">
      ...
      <div class="prose prose-invert prose-lg max-w-none
        ...
        <section class="mb-8">
          <h2>For Germany: Angaben gemäß § 5 TMG</h2>
          <h3>Diensteanbieter / Website Provider</h3>
          <p>
            Diese Webseite wird bereitgestellt von / This website is provided by:<br>
            <strong>Oliver Zimpasser</strong>
          </p>
          <p>
            Berliner Str. 39a<br>
            63110 Rodgau<br>
        ...
        <section class="mb-8">
          ...
          <p>
            <strong>E-Mail:</strong> <a href="mailto:oglimmer@gmail.com">oglimmer@gmail.com</a><br>
            <span class="text-sm text-white/60">(Angaben zur schnellen elektronischen Kontaktaufnahme und unmittelbaren Kommunikation gem. § 5 Abs. 1 Nr. 2 TMG)</span>
          </p>
        </section>
        ...
        <section class="mb-8">
          ...
          <p>
            Verantwortlich für den Inhalt / Responsible for content:<br>
